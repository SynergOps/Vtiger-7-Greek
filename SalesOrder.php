...
$languageStrings = array(
	'SalesOrder' => 'Παραγγελίες πωλήσεων',
    //DetailView Actions
	...
	//Basic strings
	'LBL_ADD_RECORD' => 'Προσθήκη Παραγγελίας Πωλήσεων',
	'LBL_RECORDS_LIST' => 'Λίστα Παραγγελιών Πωλήσεων',

	// Blocks
	'LBL_SO_INFORMATION' => 'Λεπτομέρειες Παραγγελιών Πωλήσεων',
