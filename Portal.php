...
$languageStrings = array(
	...
	'LBL_BOOKMARK_URL' => 'Διεύθηνση Σελιδοδείκτη (Url)',
	...
	'LBL_BOOKMARK_SAVED_SUCCESSFULLY' => 'Ο Σελιδοδείκτης αποθηκεύτικε επιτυχώς',
	'LBL_RECORD_DELETED_SUCCESSFULLY' => 'Η εγγραφή διαγράφηκε επιτυχώς',
	'LBL_OUR_SITES_LIST' => 'Our Sites List',
	'LBL_BOOKMARKS_LIST' => 'Λίστα με τις ιστοσελίδες μας',
	'LBL_BOOKMARKS_DELETED_SUCCESSFULLY' => 'Οι σελιδοδείκτες διαγράφηκαν με επιτυχία',
...
$jsLanguageStrings = array(
	'JS_ENTER_MANDATORY_FIELDS' => 'Εισαγάγετε όλα τα υποχρεωτικά πεδία',
);
